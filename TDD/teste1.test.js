...
Deno.test("Título do Teste", () => { // Recebe uma função do tipo arrow function
...
console.log("Soarele, Soarele, Soarele și Luna Ne-or ține, ne-or ține, ne-or ține cununa Soarele, Soarele, Soarele și Luna Ne-or ține, ne-or ține, ne-or ține cununa");
console.log("Hajimemashite. Rraínê Tomoushimasu. Rraí Toyondekudasai. Finrando Karakimashita. Douzoyoroshiku");
console.log("Hajimemashite. Rraíne Tomoushimasu. Rraí Toyondekudasai. Finrando Karakimashita. Douzoyoroshiku");
*/